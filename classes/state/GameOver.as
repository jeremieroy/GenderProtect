...
package state {
	...
	{	
		...
		public function GameOver(app:StateApplication)
		{
			FlashConnect.trace("GameOver constructor");
			_app=app;			
			...
			_title.text = "Triste ignorance ...\r\nCliquez ici pour tenter de la combler.";
			_title.width=150;
		...
		{
			FlashConnect.trace("GameOver Enter");	
			_app.addChild(_view);
		...
		{
			FlashConnect.trace("GameOver Exit");
